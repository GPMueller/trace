...
void throw_exception( const std::string & message, const char * file, unsigned int line );

// Rethrow (creates a std::nested_exception) an exception, using the trace_exception class
...
class trace_exception : public std::runtime_error
{
  ...
  public:
    trace_exception( const std::string & message, const char * file, unsigned int line )
